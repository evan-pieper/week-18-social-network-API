...
module.exports = {
    async createReaction(req, res) {
        try {
            // Find the thought by ID and update it by pushing a new reaction into the reactions array
    ...
    async deleteReaction(req, res) {
        try {
            // Find the thought by ID and update it by pulling a reaction from the reactions array
            const thought = await Thought.findByIdAndUpdate(
              req.params.thoughtId,
